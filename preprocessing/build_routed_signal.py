...
np.savez_compressed(f"{GTS}/routed_od_signal.npz",
...
print(f"saved routed_od_signal.npz: routed_actual {routed_actual.shape}, routed_forecast {routed_forecast.shape}")
