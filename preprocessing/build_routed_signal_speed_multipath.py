"""Multipath version of build_routed_signal_speed.py -- applies routing_weights_speed_multipath.npz's
...
np.savez_compressed(f"{GTS}/routed_od_signal_speed_multipath.npz",
                     routed_forecast=routed.astype(np.float32),
                     sensor_link_ids=rw["sensor_link_ids"])
print(f"saved routed_od_signal_speed_multipath.npz: {routed.shape}")
